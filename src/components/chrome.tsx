    ...
    <div className="nav">
      <div className="nav-inner">
        <a href="index.html" className="wordmark">
          ...
          <span>lindblad</span>
          <span className="tag" style={{ marginLeft: 8 }}>R.1.7.3</span>
        </a>
        ...
        <div className="flex justify-between" style={{ flexWrap: 'wrap', gap: 32 }}>
          ...
          <div className="flex gap-48" style={{ flexWrap: 'wrap' }}>
            ...
            <div className="flex-col gap-8">
              ...
              <span className="text-faint mono" style={{ fontSize: 12 }}>Lindblad SLA v2.0</span>
            </div>
          </div>
        </div>
        <hr className="rule mt-48" />
        <div className="flex justify-between mt-24" style={{ flexWrap: 'wrap', gap: 16 }}>
          <span className="mono text-faint" style={{ fontSize: 12 }}>BUILD R.1.7.3 · 538/538 · 66 SUITES</span>
