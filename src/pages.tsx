    ...
    <section style={{ paddingTop: 80, paddingBottom: 64, borderTop: 0 }}>
      <div className="container">
        <div className="flex gap-12 items-center">
          ...
          <span className="eyebrow">RELEASE 1.1.23.1 · 2548/2548 TESTS PASSING · 233 SUITES</span>
        </div>
        ...
        <div className="grid mt-64" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 16 }}>
          ...
          <Stat label="LINES OF C++" value={<Counter to={42000} suffix="+" />} sub="2548 unit tests · 233 test suites" />
        </div>
      </div>
    </section>
  );
...
`<span class="fn">FetchContent_Declare</span>(
    ...
    <span class="cm"># GIT_TAG        1.1.23.1</span>
)
...
<span class="fn">target_link_libraries</span>(my_app <span class="ty">PRIVATE</span> lindblad_core)`
            ...
            <div className="flex justify-between items-center" style={{ padding: '10px 18px', borderTop: '1px solid var(--rule)', background: 'var(--surface-2)' }}>
              <span className="mono text-faint" style={{ fontSize: 11 }}>LATEST RELEASE · 1.1.23.1</span>
...
$ ctest --test-dir build --output-on-failure
   2548/2548 tests passed across 233 suites`
              }} />
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-12 mt-16" style={{ flexWrap: 'wrap' }}>
          ...
          <a href="https://github.com/verycareful/lindblad/releases/tag/1.1.23.1" target="_blank" rel="noopener" className="btn">↗ 1.1.23.1 RELEASE NOTES</a>
        </div>
      </div>
    </section>
  );
...
const FAQ_ITEMS = [
  ...
  { q: 'Can I publish benchmarks comparing LINDBLAD to other simulators?', a: 'Yes, under the academic license. We ask that you cite the release version you benchmarked (e.g. 1.1.23.1) and report hardware specs alongside any performance numbers.' },
...
<span class="ty">version</span>:      <span class="st">"1.1.23.1"</span>
